...
public class GeraRelatorio {
    ...
    public GeraRelatorio() {
        ...
        this.pathToReportPackage = path.split("rhppp")[0] + "rhppp/src/main/java/br/com/rhppp/relatorio/";
    ...
    public void imprimir(List<Curriculo> curriculos) throws Exception {
        JasperReport report = JasperCompileManager.compileReport(this.getPathToReportPackage() + "curriculoCandidato.jrxml");
        ...
        String caminho = path.split("rhppp")[0] + "sgoec/src/main/webapp/resources/relatorios/curriculoCandidato.pdf";
