...
<template:admin>
	...
	<div class="container-fluid">
			...
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					<div class="fresh-table toolbar-color-orange">
						...
						<div class="toolbar">
							<button id="btnCadastrarCargo" class="btn btn-default"
									type="button" onclick="cargo.modalShowCadastroCargo()">Cadastrar</button>
						</div>
		...
		<c:import url="/view/empresa/include/cargo/cadastro-cargo.jsp" />
	</div>
