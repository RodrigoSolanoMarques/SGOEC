...
<!-- 			src="/static/js/bootstrap-table/jquery-1.11.2.min.js"></script> -->
	...
	<div class="container-fluid">
			...
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					<div class="fresh-table toolbar-color-orange" >
						...
						<div class="toolbar">
							<button id="btnCadastrarEmpregador" class="btn btn-default" type="button" onclick="empresa.modalShowCadastroEmpresa()">Cadastrar</button>
						</div>
				        ...
				        <table id="tableEmpresas" class="table"
				            ...
				            <tr>
				            	...
				            	<th data-field="razaoSocial">Razao Social</th>
				            	<th data-field="nomeFantasia">Nome Fantasia</th>
				            	<th data-field="cpfCnpj">CPF/CNPJ</th>
				            </tr>
				            </thead>
				        </table>
	    			</div>
		...
		<c:import url="/view/empresa/include/empresa/cadastro-empresa.jsp" />
	</div>
